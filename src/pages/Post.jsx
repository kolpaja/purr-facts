  ...
  return (
    <div className='w-full p-10 flex flex-col justify-center items-center m-auto'>
      ...
      <div className='fact-message mb-10 relative w-[500px] h-[300px] '>
        ...
        <div className='ring-2 absolute left-[50px] w-[100px] h-[100px] bottom-0 rounded-full ring-green-400'>
          <img
            src={catLogo}
        ...
        {/* small circles */}
        <div className='absolute z-20 left-[170px] bottom-[100px] bg-white border border-slate-400 w-6 h-6 rounded-full' />
        <div className='absolute z-20 left-[150px] bottom-[80px] bg-white border border-slate-400 w-4 h-4 rounded-full' />
        <div className='absolute z-20 left-[130px] bottom-[60px] bg-white border border-slate-400 w-3 h-3 rounded-full' />
      </div>
